...
local function getresolver(listt, filter)
	local huo = type(filter)
...
function library:CreateWindow(options)
	...
	headline.TextStrokeColor3 = Color3.fromRGB(15, 15, 15)
		...
		function tabFunctions:CreateSection(options)
			...
			function sectionFunctions:AddToggle(options)
				...
				local objectdata = {
					...
					Type = "Toggle",
					Name = flagName,
					Default = not not library.flags[flagName],
					Parent = sectionFunctions,
			...
			function sectionFunctions:AddTextbox(options)
				...
				local function resolvevalue(val)
					...
					if options.PostFormat then
						...
						if typ == "function" then
							local x, e = pcall(options.PostFormat)
							if not x and e then
				...
				local objectdata = {
					...
					Name = flagName,
					Type = "Textbox",
					Default = library.flags[flagName],
					Parent = sectionFunctions,
			...
			function sectionFunctions:AddSearchBox(options)
				...
				local showing = false
				local oldzindex = newSection.ZIndex
				local function display(dropdownEnabled, f)
					if submenuOpen == dropdown or submenuOpen == nil then
						if dropdownEnabled then
							...
							submenuOpen = nil
							dropdownToggle.Rotation = 90
							newSection.ZIndex = oldzindex or (newSection.ZIndex - 50)
							newDropdown.ZIndex = 1
							sectionHolder.ZIndex = 1
							colored_dropdown_BackgroundColor3[3] = "topGradient"
							colored_dropdown_BackgroundColor3[4] = nil
						...
						for _, options in pairs({{
							...
							Callback = function()
								if savecallback then
									local x, e = pcall(savecallback, library.flags[flagName])
									if not x and e then
								...
								if good and content then
									writefile(string.format("%s/%s.txt", common_string, filenameddst), content)
								end
								if postsave then
									local x, e = pcall(postsave, library.flags[flagName])
									if not x and e then
								...
								Callback = function()
									if loadcallback then
										local x, e = pcall(loadcallback, library.flags[flagName])
										if not x and e then
									...
									if postload then
										local x, e = pcall(postload, library.flags[flagName])
										if not x and e then
			...
			function sectionFunctions:AddColorpicker(options, designers)
				...
				colorPicker.BorderColor3 = Color3.fromRGB(20, 20, 20)
				...
				colorPicker.ImageColor3 = Color3.fromRGB(29, 29, 29)
				...
				colorPickerInner.BorderColor3 = Color3.fromRGB(20, 20, 20)
				...
				colorPickerHeadline.Text = (colorPickerName and colorPickerName or "???")
				colorPickerHeadline.TextColor3 = Color3.fromRGB(147, 145, 147)
				...
				library.signals[1 + #library.signals] = colorPickerButton.MouseButton1Click:Connect(function()
					if submenuOpen == colorPicker or submenuOpen == nil then
						...
						if colorPickerEnabled then
							...
							colorPickerButton.BorderColor3 = Color3.fromRGB(20, 20, 20)
						end
					end
				end)
				...
				colorPickerHolderFrame.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
				colorPickerHolderFrame.BorderColor3 = Color3.fromRGB(20, 20, 20)
				...
				colorPickerHolderFrame.ImageColor3 = Color3.fromRGB(29, 29, 29)
				...
				colorPickerHolderInner.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
				colorPickerHolderInner.BorderColor3 = Color3.fromRGB(20, 20, 20)
				...
				colorPickerHolderInner.ImageColor3 = Color3.fromRGB(29, 29, 29)
				...
				hexInput.BorderColor3 = Color3.fromRGB(20, 20, 20)
				...
				hexInput.ImageColor3 = Color3.fromRGB(29, 29, 29)
				...
				hexInputInner.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
				hexInputInner.BorderColor3 = Color3.fromRGB(20, 20, 20)
				...
				hexInputInner.ImageColor3 = Color3.fromRGB(29, 29, 29)
				...
				hexInputBox.TextColor3 = Color3.fromRGB(147, 145, 147)
				...
				randomColor.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
				randomColor.BorderColor3 = Color3.fromRGB(20, 20, 20)
				...
				randomColor.ImageColor3 = Color3.fromRGB(29, 29, 29)
				...
				randomColorInner.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
				randomColorInner.BorderColor3 = Color3.fromRGB(20, 20, 20)
				...
				randomColorInner.ImageColor3 = Color3.fromRGB(29, 29, 29)
				...
				rainbow.BorderColor3 = Color3.fromRGB(20, 20, 20)
				...
				rainbow.ImageColor3 = Color3.fromRGB(29, 29, 29)
				...
				rainbowInner.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
				rainbowInner.BorderColor3 = Color3.fromRGB(20, 20, 20)
				...
				rainbowInner.ImageColor3 = Color3.fromRGB(29, 29, 29)
				...
				local function UpdateColorPicker(force, rainbsow)
					...
					if force then
						...
						selectorHue.Position = UDim2.new(1 - (Color3.toHSV(force)))
					end
				...
				local objectdata = {
					...
					Name = flagName,
					Type = "Colorpicker",
					Default = options.Value or startingColor or library.flags[flagName],
					Parent = sectionFunctions,
